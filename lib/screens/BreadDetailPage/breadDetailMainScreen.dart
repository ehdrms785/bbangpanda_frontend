...
<p id='top'><a href='#bottom'>Scroll to bottom</a></p>
      ...
      <img src='https://flutter-ko.dev/images/catalog-widget-placeholder.png' />
...
class BreadDetailMainScreen extends GetView<BreadDetailMainController> {
  @override
                ...
                : NotificationListener<ScrollNotification>(
                    ...
                    child: CustomScrollView(
                        ...
                        slivers: [
                          SliverOverlapAbsorber(
                            ...
                            sliver: AnimatedBuilder(
                              ...
                              builder: (context, child) => SliverAppBar(
                                ...
                                title: Text(
                                  controller.breadDetailInfo!.name,
                                  style: TextStyle(
                                      color: controller
                                          .appBarTextColorTween.value),
                                ),
                                toolbarHeight: 7.0.h,
                                titleSpacing: 0.0,
                                elevation: 0,
                              ...
                              child: Stack(
                                children: [
                                  Container(
                                    ...
                                    child: Image.asset(
                                      controller.breadDetailInfo!.thumbnail,
                                      fit: BoxFit.cover,
                                    ),
                                  ),
                                  Positioned.fill(
                          ...
                          Builder(
                            builder: (context) {
                              BreadDetailInfo breadData =
                                  controller.breadDetailInfo!;
                              return SliverToBoxAdapter(
                                child: GestureDetector(
                                  onTap: () {
                                    Get.to(BakeryDetailMainScreen(),
                                        arguments: {'bakeryId': 1},
                                        binding: BindingsBuilder(() {
                                      Get.lazyPut(
                                          () => BakeryDetailMainController());
                                    }));
                                  },
                                  child: Container(
                                    height: 10.0.h,
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              FeatureListTextWidget(
                                                  features:
                                                      breadData.bakeryFeatures),
                                              // Text("베이커리 Features #우리밀 #무가당"),
                                            ],
                                          ),
                                        ),
                                        GestureDetector(
                          ...
                          SliverPadding(
                            ...
                            sliver: SliverToBoxAdapter(
                              child: Container(
                                ...
                                // data:
                                //     """![Test](https://lh3.googleusercontent.com/proxy/hd4moJllDoxOUeXvz8bzO-b_XzCilTtsMLKvaCtbhtd4Kbkb2Pq4J_PEplGv503bo-b5C2PkOy7Z2NpWziBWEORcnXnPDtm8TRXoCo-l3GEwvpfgqC6HpaRe)
                                //     """),
                              ),
                            ),
                          )
